...
# NOTE: The KITTI-360 segmentation dataset has 19 classes, sky is obviously omitted
#      rider is omitted because it is a dynamic object and therefore not included in the segmentation dataset
#      train and bus are omitted since they are not present in the validation set
#      So overall we operate on 15 classes!
...
labels = [
    ...
    Label("license plate", -1, -1, 255, "vehicle", 7, False, True, True, (0, 0, 142)),
]
